...
{
    public class HubPnPClientFixture
    {
        ...
        public async Task ConnectDeviceWithSas()
        {
            ...
            var hubClient = new PnPClient(await IoTHubConnectionFactory.CreateAsync(cs));
        ...
        public async Task ConnectDeviceWithX509()
        {
            ...
            var hubClient = new PnPClient(await IoTHubConnectionFactory.CreateAsync(csx));
            Assert.True(hubClient.Connection.IsConnected);
